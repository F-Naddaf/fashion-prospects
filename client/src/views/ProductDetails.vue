...
export default {
  ...
  async mounted() {
    ...
    try {
      await fetch(
        `https://fashion-prospects-production.up.railway.app//api/users/add-to-recent/${this.productId}`,
        {
          method: 'PATCH',
          headers: {
      ...
      const result = await fetch(
        `https://fashion-prospects-production.up.railway.app//api/products/product_detail/${this.productId}`,
      );
